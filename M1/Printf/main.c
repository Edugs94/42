...
/*   Updated: 2025/10/21 18:54:12 by egalindo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    printf("%d. System: [Single percent at the end%", test_num);
	printf("\n");
    ft_printf("%d. Mine:   [Single percent at the end%", test_num++);
	printf("\n");
    printf("%d. System: You should see %% and ) --> %)", test_num);
	printf("\n");
    ft_printf("%d. Mine: You should see %% and ) --> %)", test_num++);
	printf("\n");
    printf("%d. System: You should see %% and nothing else ) --> %t", test_num);
	printf("\n");
    ft_printf("%d. Mine: You should see %% and nothing else ) --> %t", test_num++);
	printf("\n");
